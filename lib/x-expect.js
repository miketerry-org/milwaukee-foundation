 ...
 */
export default function expect(name, value = undefined, errors = undefined) {
  let ok = typeof name === "string";
  assert.strictEqual(typeof name, true, `"name" parameter must be a string`);

  ok = typeof value !== "undefined";
  assert.strictEqual(ok, true, `"value" parameter cannot be undefined`);
